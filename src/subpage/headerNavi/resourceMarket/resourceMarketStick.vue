  ...
  <div class="release_paper" @click="authCheck">
    <div class="release_paper_con">
      ...
      <div class="release_paper_mes">
        ...
        <div class="mes_right">
          <div class="paper_is">
            <div class="big_w" v-if="bigImg"  style="position:absolute; left:-2%; top: 84%; z-index: 999;" @click="imgScc" title="放大">+</div> 
          ...
          <div class="paper_the">
            <div class="big_w" v-if="bigImgs" style="position:absolute; left:-2%; top: 84%; z-index: 999; background:fff; color:#333; " @click="imgSccs" title="放大">+</div>
