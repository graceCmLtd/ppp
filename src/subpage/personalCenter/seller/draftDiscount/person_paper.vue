      ...
      <div class="hadOffer" v-show="hadOffer">
        ...
        <div class="person-offerIn" v-for = "item in noteL ">
          ...
          <span @click="linkToA(index)">
            <a v-bind:href="linka" style="text-decoration:none"><img  style="width:95px; height:25px; position:relative; top: 7px;" src="../../../../../static/img/qq_img.png" title="QQ咨询"></a></span>
...
<script>
  ...
  import personOfferin from '@/subpage/personalCenter/seller/draftDiscount/person_offerIn'
  import personOfferbe from '@/subpage/personalCenter/seller/draftDiscount/person_offerBe'
  export default {
    data(){
      return{
        color:1,
